...
const files=['config','utils','audio','physics','lifesystems','emotions','massphysics','furry','world','hands','player','playerbody','bodyspots','cocoon',
...
const need=['GameClass','CONFIG','U','ZONES','AudioEngine','BodyPhysics','FurryEngine','World','HandsSystem',
  'PlayerController','PlayerBody','DigestionSystem','TailSystem','UnderBellyAmbience','EmotionEngine','ProximitySystem','QuirkSystem','MassPhysics','BodySpots','CocoonSystem'];
