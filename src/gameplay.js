...
(function (global) {
  ...
  const DIALOGUE = {
    artyom: {
      greet: [
        'Ой! Кто-то пришёл! Извините, я тут... А, вы! Слышал о вас в городе.',
        'Доброе утро! Только что закончил ночной эксперимент. Кофе будете?',
        'Ох, весь день варю зелья. Спина болит... но это того стоит!',
        'Скоро закат. Люблю это время... магия эликсиров усиливается.',
        'Ой, вы поздно! Я варю лунный эликсир. Хотите посмотреть?',
      ],
      first: 'Ой! Ты пришёл с... о боже, какой он у тебя мягкий и большой! Постой, я записываю... «субъект демонстрирует высокий уровень мягкости»...',
      about_furry: [
        'Твой друг в отличной форме! Здоровый гигант.',
        'Массаж очень полезен. Сходите в спа!',
        'Ему нужен отдых. Не заставляйте двигаться без эликсира.',
        'Знаете, что усваивается лучше всего? Домашняя еда с любовью.',
      ],
      flirt: [
        'Знаете... вы очень добрый человек. Я редко такое встречаю.',
        'Мне нравится, когда вы приходите. Становится веселее.',
        'Может, как-нибудь погуляем? Просто так, без работы?',
      ],
      idle: [
        'А что если... нет, слишком опасно... хотя!',
        'Я тут думаю о новом эликсире... но нужны редкие ингредиенты.',
        'Расскажу вам легенду о драконьем молоке?',
        'Полнолуние! Идеальное время для лунного сахара.',
      ],
    },
    milli: { greet: ['Ой, какой у тебя друг! Он такой... мягкий!', 'Свежие пончики! Только из печи~', 'Слышал новости? Мэр опять раздаёт награды!'] },
    bruno: { greet: ['Шоколад — это счастье в твёрдой форме, дружище!', 'Хочешь, покажу трюк с темперированием?', 'Твой друг заслуживает шоколадную ванну!'] },
    victoria: { greet: ['Мон шер, торты — это искусство, а не еда.', 'Многоярусный торт? Раз в неделю, не чаще.', 'Ваш спутник... впечатляющих объёмов. Прелестно.'] },
    barry: { greet: ['ГАВ! Ой, извини. Хлеб будешь?', 'Тесто само себя не замесит!', 'Держи муку, друг! Бесплатно, для тебя!'] },
    ignatiy: { greet: ['Насос откалиброван. Можем начинать.', 'Гига-коктейль — вершина инженерной мысли.', 'Пятьсот калорий за подход. Это наука, не обжорство.'] },
    hopkins: { greet: ['Утро доброе! Коровы уже ждут.', 'Мёд свежий, пчёлы довольные.', 'Хочешь свой участок? Сто монет и он твой.'] },
    sebastian: { greet: ['...Мука.', 'Жернова помнят всё.', 'Принеси зерно — будет мука.'] },
    mei: { greet: ['Расслабься. Дыши. Всё хорошо.', 'После массажа еда усваивается лучше. Проверено.', 'У твоего друга зажим в области третьей складки.'] },
    athena: { greet: ['Тише, пожалуйста. Книги спят.', 'Хочешь узнать историю Sugar City?', 'Атлас мира — на третьей полке.'] },
    pippa: { greet: ['Быстро-быстро! У меня 40 посылок!', 'Тебе письмо! Кажется, от Артёма.', 'Доставка из другого города — завтра.'] },
    tiberiy: { greet: ['Город гордится вами!', 'Такого большого фурри у нас ещё не было.', 'Приём раз в неделю, но для вас — всегда.'] },
    horatio: { greet: ['Мее... давно тут никого не было.', 'Горы хранят рецепты, которых нет в книгах.', 'Лунный сахар собирают только в полнолуние. Запомни.'] },
    musician: { greet: ['*играет ло-фай* ...монетку?', 'Эта песня — про толстых и счастливых.', 'Музыка делает еду вкуснее, знаешь?'] },
    couple: { greet: ['Мы женимся! Нужен торт...', 'Правда, он милый? *хихикают*', 'Спасибо, что помогаешь!'] },
    banker: { greet: ['Ваш счёт в безопасности.', 'Кредит? Обсудим... под 3%.', 'Взлом сейфа? Это шутка, надеюсь.'] },
    merchant: { greet: ['Лучшие товары в городе!', 'Ванильные бобы — только у меня.', 'Скидка для постоянных!'] },
    tailor: { greet: ['Эластичная линейка растёт вместе с ним!', 'Опять порвал? Это нормально.', 'Размер XXXXL? Сделаем.'] },
    dj: { greet: ['Бит качает, малыш!', 'Танцпол мягкий — специально для больших.', 'Сегодня особый сет.'] },
  };
