...
(function (global) {
  ...
  const ZONES = [
    ...
    Z('lower_left_glute', 'Нижняя левая ягодица', 'glutes', [-0.25, 0.80, -0.34], [-0.30, -0.15, -1.5], 0.46, 1.45, SPEED.LIGHTNING, 0.94, 0.21, 30, true,
      { folds: [10000, 40000], sound: 'ploh' }),
    Z('lower_right_glute', 'Нижняя правая ягодица', 'glutes', [0.25, 0.80, -0.34], [0.30, -0.15, -1.5], 0.46, 1.45, SPEED.LIGHTNING, 0.94, 0.21, 30, true,
      { folds: [10000, 40000], sound: 'ploh' }),
    Z('upper_left_glute', 'Верхняя левая ягодица', 'glutes', [-0.23, 1.00, -0.34], [-0.22, 0.18, -1.4], 0.40, 1.05, SPEED.FAST, 0.9, 0.24, 18, true),
    Z('upper_right_glute', 'Верхняя правая ягодица', 'glutes', [0.23, 1.00, -0.34], [0.22, 0.18, -1.4], 0.40, 1.05, SPEED.FAST, 0.9, 0.24, 18, true),
