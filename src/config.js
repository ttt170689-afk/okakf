...
(function (global) {
  ...
  const ZONES = [
    ...
    Z('muffin_top', 'Muffin top', 'belly', [0, 0.94, -0.02], [0, 0.4, 0], 0.55, 0.34, SPEED.MEDFAST, 0.88, 0.28, 12, true,
      { folds: [9000] }),
    Z('side_belly_folds', 'Боковые складки живота', 'belly', [-0.46, 0.88, 0.16], [-0.8, -0.2, 0.5], 0.36, 0.62, SPEED.MEDSLOW, 0.92, 0.24, 11, true,
      { mirror: 'right', folds: [15000] }),
    Z('subrib_fold', 'Подрёберная складка', 'belly', [0, 1.34, 0.16], [0, -0.3, 1], 0.30, 0.46, SPEED.MEDSLOW, 0.86, 0.30, 9, true),
    ...
    Z('left_cheek', 'Левая щека', 'face', [-0.13, 2.02, 0.14], [-0.7, 0, 0.8], 0.13, 0.16, SPEED.MEDFAST, 0.8, 0.32, 3, true, { sound: 'squish' }),
    Z('right_cheek', 'Правая щека', 'face', [0.13, 2.02, 0.14], [0.7, 0, 0.8], 0.13, 0.16, SPEED.MEDFAST, 0.8, 0.32, 3, true, { sound: 'squish' }),
    Z('chin1', 'Первый подбородок', 'face', [0, 1.92, 0.16], [0, -0.5, 1], 0.15, 0.20, SPEED.MEDFAST, 0.9, 0.26, 4, true),
    Z('chin2', 'Двойной подбородок', 'face', [0, 1.85, 0.15], [0, -0.7, 0.9], 0.17, 0.26, SPEED.MEDSLOW, 0.93, 0.22, 6, true, { folds: [14000] }),
    Z('chin3', 'Тройной подбородок', 'face', [0, 1.78, 0.13], [0, -0.85, 0.8], 0.19, 0.30, SPEED.VERYSLOW, 0.95, 0.20, 8, true, { folds: [40000] }),
    Z('front_neck', 'Передняя шея', 'neck', [0, 1.76, 0.10], [0, -0.2, 1], 0.20, 0.28, SPEED.MEDSLOW, 0.9, 0.25, 7, true),
