...
(function (global) {
  ...
  const U = {
    ...
    fmt(n) {
      /* Числа выросли: запасы склада измеряются триллионами, а пороги
       * поздних стадий — сотнями триллионов калорий. Без этих ступеней
       * всё выше миллиарда печаталось как «999999.99млрд». */
      if (!isFinite(n)) return '∞';
      if (n >= 1e15) return (n / 1e15).toFixed(2) + 'квадр';
