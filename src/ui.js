      ...
      switch (kind) {
        ...
        case 'help': {
          ...
          html += `<div class="p-body"><div class="keys">
            ...
            <div><kbd>X</kbd> ползти · <b>внутри тела — выбраться</b></div>
            <div><kbd>E</kbd> стоя на друге — <b>сесть / лечь / поспать</b></div>
            <div><kbd>Shift</kbd> бег / усилить хват</div>
            <div><kbd>Z</kbd> обнять друга · <kbd>V</kbd> помахать рукой</div>
            <div><kbd>ЛКМ</kbd> левая рука: тычок, массаж, хват (рука летит к цели)</div>
          ...
          <ul class="tips">
            ...
            <li>Хвататься можно за <b>любую точку</b> меша: луч из курсора бьёт по
                треугольникам тела, и рука цепляется именно туда, куда смотришь.
                Но за складку держаться надёжно, а за гладкую голову рука быстро соскользнёт.</li>
            <li>Присядь (Ctrl) у большого живота — попадёшь в тёплые «пещеры» под ним.</li>
            <li><b>X</b> — ползти: так пролезешь под живот и под низкую мебель.</li>
            <li>Застрял в друге? <b>X</b> или <b>Space</b> — выбраться. Через 2 секунды
                неподвижности включится режим призрака, через 3 — вытолкнет само.</li>
            <li><b>Z</b> — обнять друга, <b>V</b> — помахать рукой. Он это запомнит.</li>
            <li>Под животом слышно сердце и урчание — внешний мир глохнет.</li>
            <li>Усни на друге 10-й стадии — складки сомкнутся, и ты окажешься
                в тёплом коконе. Выбраться: <b>X</b>, <b>F</b> или просто пойти.</li>
            <li>Залезь на друга и нажми <b>E</b>: можно сидеть, лежать, спать до утра,
                прятаться в складках и даже устроить пикник на «полке» над попой.
                Отдых на друге восстанавливает силы и очень его радует.</li>
          </ul></div>`;
          break;
        }
